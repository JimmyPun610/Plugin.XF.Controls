...
using Plugin.XF.Controls.Shared.Effects;
...
namespace Plugin.XF.Controls.iOS.Effects
{
    public class EntryWithToolbarEffect : PlatformEffect
    {
        ...
        {
            var effect = (Plugin.XF.Controls.Shared.Effects.EntryWithToolbarEffect)Element.Effects.FirstOrDefault(e => e is Plugin.XF.Controls.Shared.Effects.EntryWithToolbarEffect);
